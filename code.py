...
def main():
    ...
    user_avator = '/root/finance_assistant/code/InternLM/assets/user.png'
    robot_avator = '/root/finance_assistant/code/InternLM/assets/robot.png'

    st.title('金融财经公告解读大模型')
